...
public extension DefaultsKeys {
    ...
    // iCloud keys
    static let iCloudID =  DefaultsKey<String?>("iCloudID")
    static let iCloudLastLoginDate = DefaultsKey<Date?>("iCloudLastLoginDate")
    static let iCloudAvatar = DefaultsKey<Data?>("iCloudAvatar")
